...
foreach ($needle in @("/v1/version", "skybridge.server_version.v1", "SKYBRIDGE_COMMIT_SHA", "SKYBRIDGE_IMAGE_TAG", "SKYBRIDGE_BUILD_TIME", "SKYBRIDGE_SERVER_VERSION", "token_printed: false")) {
