...
try {
  ...
  Invoke-ManagedModeRunJson "run-finalizer-apply" @("-StateDir", $stateDir, "-SimulateFinalizerMergedPr") | Out-Null
  $second = Invoke-ManagedModeRunJson "run-finalizer-apply" @("-StateDir", $stateDir, "-SimulateFinalizerMergedPr")
