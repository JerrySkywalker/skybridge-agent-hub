...
$result = Invoke-JsonScript "skybridge-desktop-launch-diagnostics.ps1" @("-Command", "safe-summary")

Assert-True $result.ok "desktop_launch_safety_ok"
...
Complete-Smoke "desktop-launch-safety"
