...
$result = Invoke-OperatorTuiInputUxSmoke `
  -Name "operator-tui-input-no-real-execution" `
  -Scenario "no-real-execution" `
  -Reset

Assert-OperatorTuiInputUxNoRealExecution -Report $result.report
...
Complete-Smoke "operator-tui-input-no-real-execution"
