...
$blocked = Invoke-ManagedModePilotJson "pilot-apply" "low-docs" @("-RequireRenewedAuthorization", "-SimulateApply")
...
$allowed = Invoke-ManagedModePilotJson "pilot-apply" "low-docs" @("-RequireRenewedAuthorization", "-RenewedAuthorization", "-RenewedAuthorizationReason", $reason, "-SimulateApply")
