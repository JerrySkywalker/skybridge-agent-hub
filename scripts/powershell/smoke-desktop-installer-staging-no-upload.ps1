...
$result = Invoke-JsonScript "skybridge-desktop-installer-staging.ps1" @("-Command", "safe-summary")

Assert-True $result.ok "desktop_installer_staging_no_upload_ok"
...
Complete-Smoke "desktop-installer-staging-no-upload"
