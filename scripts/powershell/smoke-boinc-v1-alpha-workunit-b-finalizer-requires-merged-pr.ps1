...
$json = (& pwsh -NoLogo -NoProfile -ExecutionPolicy Bypass -File (Join-Path $PSScriptRoot "skybridge-boinc-v1-alpha.ps1") -Command workunit-b-finalizer-preview -SimulateWorkunitAFinalized -SimulateWorkunitBExecuted -SimulateWorkunitBPrMissing -Json | Out-String).Trim() | ConvertFrom-Json
