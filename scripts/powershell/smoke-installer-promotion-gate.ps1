...
$r = Invoke-SmokeJson "skybridge-installer-promotion.ps1" @("-Command", "promotion-gate")
Assert-Truthy $r.gate "promotion gate"
...
Write-Host "[smoke-installer-promotion-gate] ok gate=$($r.gate)"
