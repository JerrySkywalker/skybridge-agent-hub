...
foreach ($command in @("status", "alpha-preview", "alpha-apply-gate", "alpha-safe-summary", "blocked-state", "workunit-a-finalizer-preview", "workunit-a-finalizer-evidence", "workunit-a-finalizer-report", "workunit-b-apply-gate", "workunit-b-hold-report", "workunit-b-finalizer-preview", "workunit-b-finalizer-evidence", "workunit-b-finalizer-report", "alpha-completion-readiness")) {
