...
if ($readiness.multi_workunit_queue_enabled -ne $false) { throw "Multi-workunit queue must be disabled." }
Write-ManagedModeV0SmokeResult "managed-mode-v0-general-bounded-queue-disabled"
