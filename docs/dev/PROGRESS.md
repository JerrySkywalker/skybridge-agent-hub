...
- Local validation passed for the new status/proposal smokes, PowerShell parse validation and server typecheck. Real cloud proposal pilot evidence is still pending later in Super 181.
