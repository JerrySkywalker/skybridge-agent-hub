...
- Shared redaction rules live at `packages/event-schema/src/redaction-rules.json`.
...
- Consume the shared JSON redaction rules directly from PowerShell hook scripts.
